...
function makeConfig(tracker: Partial<ServiceConfig['tracker']>): ServiceConfig {
  return {
    ...
    claude: { model: null, command: 'claude', permission_mode: 'bypassPermissions', allowed_tools: [], setting_sources: [], turn_timeout_ms: 3_600_000, read_timeout_ms: 5_000, stall_timeout_ms: 300_000, system_prompt: { type: 'preset', preset: 'claude_code' }, settings: { attribution: { commit: null, pr: null } } },
    server: { port: null },
  }
}
